...
bb_5:
  ...
  br i1 %r2, label %bb_7, label %bb_6
...
bb_14:
  ...
  store i32 %r16, i32* %t4.addr
  %r17 = load i32, i32* %t4.addr
...
bb_17:
  ...
  store i32 %r19, i32* %t5.addr
  %r20 = load i32, i32* %t5.addr
